<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script><script type="text/javascript" src="//wurfl.io/wurfl.js"></script><script src="https://cdn.jsdelivr.net/npm/js-cookie@2/src/js.cookie.min.js"></script><script type="text/javascript" src="/bundle.js"></script><link rel="stylesheet" href="/main.css"></head><body><h1>node-url</h1><p><a href="https://travis-ci.org/defunctzombie/node-url"><img src="https://travis-ci.org/defunctzombie/node-url.svg?branch=master" alt="Build Status"></a></p>
<p>This module has utilities for URL resolution and parsing meant to have feature parity with node.js core <a href="http://nodejs.org/api/url.html">url</a> module.</p>
<pre><code class="language-js">var url = require(&#39;url&#39;);
</code></pre>
<h2>api</h2><p>Parsed URL objects have some or all of the following fields, depending on
...
<h3>url.parse(urlStr, [parseQueryString], [slashesDenoteHost])</h3><p>Take a URL string, and return an object.</p>
...
<h3>url.format(urlObj)</h3><p>Take a parsed URL object, and return a formatted URL string.</p>
<ul>
...
<h3>url.resolve(from, to)</h3><p>Take a base URL, and a href URL, and resolve them as a browser would for
