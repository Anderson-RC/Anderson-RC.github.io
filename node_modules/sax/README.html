...
<h2>What This Is (probably) Not</h2><ul>
...
<h2>Regarding <code>&lt;!DOCTYPE</code>s and <code>&lt;!ENTITY</code>s</h2><p>The parser will handle the basic XML entities in text nodes and attribute
...
<h2>Usage</h2><pre><code class="language-javascript">var sax = require(&quot;./lib/sax&quot;),
...
<h2>Arguments</h2><p>Pass the following arguments to the parser function.  All are optional.</p>
...
<h2>Methods</h2><p><code>write</code> - Write bytes onto the stream. You don&#39;t have to do this all at
...
state.</p>
<h2>Members</h2><p>At all times, the parser object will have the following members:</p>
...
<h2>Events</h2><p>All events emit with a single argument. To listen to an event, assign a
...
<h2>Reporting Problems</h2><p>It&#39;s best to write a failing test if you find an issue.  I will always
accept pull requests with failing tests if they demonstrate intended
behavior, but it is very hard to figure out what issue you&#39;re describing
without a test.  Writing a test is also the best way for you yourself
to figure out if you really understand the issue you think you have with
sax-js.</p><footer><div class="footer-inner"><div class="left-hand-text">Each-B thing here</div><div class="clear"></div></div></footer></body></html>