...
<pre><code class="language-javascript">sqs.receiveMessage(params, function(err, data) {
...
<h2>2. Moved response.data.RequestId to response.requestId</h2><p>The SDK now stores request IDs for all services in a consistent place on the
...
<pre><code class="language-javascript">svc.operation(params, function (err, data) {
  console.log(&#39;Request ID:&#39;, data.RequestId);
});
</code></pre>
<p>To the following:</p>
<pre><code class="language-javascript">svc.operation(params, function () {
  console.log(&#39;Request ID:&#39;, this.requestId);
});
</code></pre>
<h2>3. Exposed Wrapper Elements</h2><p>If you use {AWS.ElastiCache}, {AWS.RDS}, or {AWS.Redshift}, you must now access
...
<pre><code class="language-javascript">{ Parameters: [ ... ] }
</code></pre>
<p>This operation now returns:</p>
<pre><code class="language-javascript">{ EngineDefaults: { Parameters: [ ... ] } }
</code></pre>
...
<h2>4. Dropped <code>.Client</code> and <code>.client</code> Properties</h2><p>The <code>.Client</code> and <code>.client</code> properties have been removed from Service objects.
...
</code></pre><p>Should be changed to the following:</p>
<pre><code>var sts = new AWS.STS();
sts.operation(...)
</code></pre><footer><div class="footer-inner"><div class="left-hand-text">Each-B thing here</div><div class="clear"></div></div></footer></body></html>